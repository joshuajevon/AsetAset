...
class RegisteredUserController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $messages = [
            ...
            'password.min' => 'Password harus terdiri dari minimal 8 huruf, huruf besar, kecil dan angka',
            'password.regex' => 'Password harus terdiri dari minimal 8 huruf, huruf besar, kecil dan angka',
