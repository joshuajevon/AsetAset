        ...
        <div class="flex h-screen flex-col border-e bg-cGold w-72">
            ...
            <div class="px-4 py-6">
                ...
                <nav aria-label="Main Nav" class="mt-6 flex flex-col space-y-1">
                    <a href="/"
                        class="flex items-center gap-2 rounded-lg px-4 py-2 text-cWhite hover:bg-[linear-gradient(rgb(0_0_0/10%)_0_0)]">
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit"
                            class="w-full flex items-center gap-2 rounded-lg px-4 py-2 text-cWhite hover:bg-[linear-gradient(rgb(0_0_0/10%)_0_0)]">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    {{-- <a href="#" class="flex items-center gap-2 rounded-lg bg-gray-100 px-4 py-2 text-cBlack">
