                ...
                <div class="col-span-1 flex flex-col justify-start items-start gap-6">
                    ...
                    <div class="w-full">
                        ...
                        <x-text-input autocomplete="false"
                            ...
                            id="nama-lengkap-register" class="mt-1 w-full" type="text" name="nama-lengkap" />
                        @error('name')
                    ...
                    <div class="w-full">
                        ...
                        <div class="mt-1 w-full flex justify-start items-center gap-8 text-sm sm:text-base">
                            <div class="flex justify-center items-center gap-2">
                                <input type="radio" id="laki-laki" name="jenis-kelamin-register" value="HTML">
                                <label for="laki-laki">Laki-laki</label>
                            </div>

                            <div class="flex justify-center items-center gap-2">
                                <input type="radio" id="laki-perempuan" name="jenis-kelamin-register" value="HTML">
                ...
                <div class="col-span-1 flex flex-col justify-start items-start gap-6">
                    ...
                    <div class="w-full">
                        ...
                        <x-text-input autocomplete="false" placeholder="Masukkan nama panggilan Anda"
                            id="nama-panggilan-register" class="mt-1 w-full" type="text" name="nama-panggilan" />
                    ...
                    <div class="w-full">
                        ...
                        <x-text-input autocomplete="false"
                            ...
                            id="nomer-handphone-register" class="mt-1 w-full" type="text" name="nomer-handphone" />
                    ...
                    <div class="w-full">
                        ...
                        <x-text-input autocomplete="false"
                            ...
                            id="ulangi-password-register" class="mt-1 w-full" type="password" name="ulangi-password" />
                        @error('nomer-handphone')
                            <div class="alert alert-danger" role="alert">{{ $message }}</div>
                        @enderror
                    </div>
