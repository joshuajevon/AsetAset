...
@section('body')
    <div class="flex">
        ...
        <div
            ...
            <a class="gold-btn flex justify-center items-center gap-1 pr-8" href="{{ route('create-seller') }}">
            ...
            <div class="flex flex-col items-center bg-cWhite rounded-xl px-8 py-16">
                <div class="flex flex-col items-center justify-center">
                    ...
                    <p class="mt-1 text-sm sm:text-base text-gray-500">
                        {{ __('
                                                                                                Setelah seller ini dihapus, semua sumber daya dan data yang terkait akan dihapus secara permanen.') }}
                    </p>
