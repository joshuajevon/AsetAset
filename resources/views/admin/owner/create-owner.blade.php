    ...
    <div class="flex">
        ...
        <div
            ...
            <form
                ...
                action="{{ route('store-owner') }}" method="POST">
                @csrf
                <div class="w-full">
                ...
                <div class="w-full">
                    ...
                    <x-text-input type="text" id="owner-address" class="mt-1 w-full" placeholder="Masukkan alamat owner"
                        name="owner_address" value="{{ old('owner_address') }}" />
                    <x-input-error :messages="$errors->get('owner_address')" class="mt-2" />
                </div>

                <div class="w-full">
                    <x-input-label for="owner-phone" :value="__('Nomor Handphone')" />
                    <x-text-input type="text" id="owner-phone" class="mt-1 w-full" placeholder="Masukkan nomor handphone owner"
