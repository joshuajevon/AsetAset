            ...
            <div class="m-5">
                ...
                <form action="{{ route('update-asset', $asset->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <select class="form-select @error('category') is-invalid @enderror" id="" name="category"
                            value="{{ $asset->category }}" aria-label="Default select example" name="category">
                    ...
                    <div>
                        ...
                        <input type="text" class="form-control @error('province') is-invalid @enderror" id=""
                            name="province" value="{{ $asset->province }}">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" class="form-control @error('city') is-invalid @enderror" id=""
                    ...
                    <div>
                        ...
                        <textarea name="description" id="" cols="30" rows="10"
                            class="form-control @error('description') is-invalid @enderror">{{ $asset->description }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" class="form-control @error('status') is-invalid @enderror" id=""
                    ...
                    @for ($i = 1; $i <= 5; $i++)
                        <img src="{{ asset('storage/asset/image' . $i . '/' . $asset->{'image' . $i}) }}" style="width:300px"
                            alt="">
