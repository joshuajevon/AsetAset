...
@section('body')
    <div class="flex">
        ...
        <div
            ...
            <h1 class="text-2xl lg:text-3xl xl:text-4xl 2xl:text-5xl font-bold text-cGold">Manage Slideshows</h1>

            <a class="gold-btn flex justify-center items-center gap-1 pr-8" href="{{ route('create-carousel') }}">
                        ...
                        <tr class="odd:bg-gray-100">
                            ...
                            <td class="whitespace-nowrap px-4 py-2">
                                <a class="bg-green-200 py-2 px-4 rounded-lg hover:bg-[linear-gradient(rgb(0_0_0/10%)_0_0)] mr-2"
                                    href="{{ route('view-carousel', ['id' => $carousel->id]) }}"><button type="submit"
                                ...
                                <a class="bg-blue-200 py-2 px-4 rounded-lg hover:bg-[linear-gradient(rgb(0_0_0/10%)_0_0)] mr-2"
                                    href="{{ route('edit-carousel', ['id' => $carousel->id]) }}"><button type="submit"
            ...
            <div class="flex flex-col items-center bg-cWhite rounded-xl px-8 py-16">
                <div class="flex flex-col items-center justify-center">
                    ...
                    <h2 class="text-2xl font-semibold text-cBlack">
                        {{ __('Anda yakin ingin menghapus slideshow ini?') }}
                    </h2>
                    <p class="mt-1 text-sm sm:text-base text-gray-500">
                        {{ __('Setelah slideshow ini dihapus, semua sumber daya dan data yang terkait akan dihapus secara permanen.') }}
                    </p>
