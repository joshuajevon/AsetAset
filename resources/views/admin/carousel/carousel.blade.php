...
@section('body')
    <div class="flex">
        ...
        <div class="flex flex-col justify-center items-start gap-8 w-full c-container py-4 sm:py-6 md:py-8 lg:py-10 xl:py-12 2xl:py-14 ml-[72px] lg:ml-[18rem] mt-16">
            ...
            <div class="flex w-full gap-2">
                ...
                <div class="flex justify-start items-center gap-2">
                    ...
                    <form action="{{ route('carousel') }}" method="GET">
                ...
                <a class="gold-btn flex justify-center items-center gap-2" href="{{ route('create-carousel') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                        stroke="currentColor" class="w-6 h-6">
                        <path stroke-linecap="round" stroke-linejoin="round"
                ...
                @foreach ($carousels as $carousel)
                    <tr class="odd:bg-gray-100">
                        ...
                        <td class="whitespace-nowrap px-4 py-2">
                            <a class="bg-green-200 py-2 px-4 rounded-lg hover:bg-[linear-gradient(rgb(0_0_0/10%)_0_0)] mr-2" href="{{ route('view-carousel', ['id' => $carousel->id]) }}"><button type="submit"
                                    class="btn btn-success">View</button></a>
                            <a class="bg-blue-200 py-2 px-4 rounded-lg hover:bg-[linear-gradient(rgb(0_0_0/10%)_0_0)] mr-2" href="{{ route('edit-carousel', ['id' => $carousel->id]) }}"><button type="submit"
                                    class="btn btn-success">Edit</button></a>
                            <form class="inline" action="{{ route('delete-carousel', ['id' => $carousel->id]) }}" method="post">
                                @csrf
                                @method('delete')
