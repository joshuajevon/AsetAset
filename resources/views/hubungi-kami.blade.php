...
@section('body')
    ...
    <section
        class="c-container bg-cLightGrey bg-cover bg-center bg-[url('/assets/tentang-kami/tentang-kami-bg-2.png')] py-6 sm:py-8 md:py-10 lg:py-12 xl:py-14 2xl:py-16 flex justify-center items-center">
        <div
