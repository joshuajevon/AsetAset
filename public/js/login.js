function submitLoginForm(e) {
    ...
    let errorMessage = $('#error-message-login')
    ...
    let passwordInput = $('#password-login');
    let passwordInputValue = passwordInput.val();

    if(emailInputValue == "" || passwordInputValue == "" || !emailRegex.test(emailInputValue)){
        errorMessage.text("Alamat email dan/atau password tidak valid")
    }else{
